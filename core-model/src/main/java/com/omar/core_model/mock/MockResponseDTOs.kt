...
val mockTimeSeriesDTO = CurrencyTimeSeriesDTO(
    ...
    timeseries = true,
    rates = mapOf(
        "2023-08-02" to mapOf(pair = Pair("KES", 124.696363)),
        "2023-06-03" to mapOf(pair = Pair("KES", 124.676363)),
        "2023-08-04" to mapOf(pair = Pair("KES", 124.996363)),
    )
)
