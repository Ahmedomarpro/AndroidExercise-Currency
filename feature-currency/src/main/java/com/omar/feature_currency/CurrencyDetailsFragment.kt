package com.omar.feature_currency
...
import com.omar.feature_currency.databinding.FragmentCurrencyDetailsBinding
        ...
        val lineDataSet =
            LineDataSet(chartData, "${args.baseCurrencyCode}-${args.destCurrencyCode}").apply {
                ...
                fillColor = ContextCompat.getColor(
                    requireContext(),
                    com.omar.core_designsystem.R.color.transluscent_green
                )
